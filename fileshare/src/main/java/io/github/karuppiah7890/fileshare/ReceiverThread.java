...
public class ReceiverThread extends Thread {
    ...
    public ReceiverThread(int port,Messenger messenger){
        ...
        File folder = new File(Environment.getExternalStorageDirectory() + "/ContiGO/Contacts");
    ...
    public void run() {
        ...
        try {
            ...
            String fileName = in.readUTF() + "_" + timeStamp;

            File receiveFile = new File(Environment.getExternalStorageDirectory() + "/ContiGO/Contacts/" + fileName);
